...
virtual host listens on HTTPS port `26501`; smoke checks must use
`https://castrum-apps.sufficit.com.br:26501`. Port 443 belongs to other/legacy
...
Only restart nginx after the syntax check succeeds. On `castrum-apps`, do not
