...
Compatibilidade CSP: nonce global é aplicado apenas a style-src. O fechamento agora usa completion.js servido pelo STS sob script-src self, mantendo o nonce dos estilos e sem relaxar a política. Chrome com CSP enforced passou nos 24 cenários. Inserir o script inline reproduz bloqueio (zero tentativas de fechamento); a versão externa registra o fechamento esperado. Suíte de 1068 e build com warnings-as-errors passaram novamente.
