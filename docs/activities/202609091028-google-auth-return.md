...
Validação: 1067 testes da suíte passaram; build Release da solução com -warnaserror passou (16 projetos, zero erros/avisos). Cinco testes novos do controlador cobrem callback/revisão/refresh, app, recusa, URI e ticket inválidos. Remover a geração da revisão fez a regressão falhar; restauração e testes verdes. A página foi exercitada em Chrome a 1280/390/320 px, claro/escuro, incluindo foco e tentativas de fechamento. Os testes simulam Google e Vault e não usam contas reais.
