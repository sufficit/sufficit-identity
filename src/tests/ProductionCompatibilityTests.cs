...
/// legado em staging-server (produção). As requisições foram capturadas dos access logs
...
///    (legacy-webforms-client, legacy-mobile-client, legacy-blazor-client, etc.),
...
public sealed class ProductionCompatibilityTests
{
    ...
    // ---- client_ids reais observados em staging-server/production ----
    private const string WebFormsClientId = "legacy-webforms-client";
    private const string WebFormsRedirectUri = "https://www.example.com/oauth/authenticated";
    private const string MobileAppsClientId = "legacy-mobile-client";
    private const string MobileAppsRedirectUri = "sufficitaigateway://callback";
    private const string MobileAiModelsClientId = "legacy-mobile-ai-client";
    private const string MobileAiModelsRedirectUri = "sufficitmobileaimodels://callback";
    private const string SwaggerClientId = "legacy-swagger-client";
    private const string SwaggerRedirectUri = "https://api.example.com/oauth2-redirect.html";
    ...
    {
        // Captura de produção (fixtures/authz-02): legacy-mobile-client com
