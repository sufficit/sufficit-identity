        ...
        IdentityUserToken<string>, IdentityUserPasskey<string>>, IDataProtectionKeyContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        if (Database.IsMySql())
        {
            ApplyOpaqueIdentifierCollations(builder);
        }
    }
    ...
    /// contract tests.
    /// </summary>
    private static void ApplyOpaqueIdentifierCollations(ModelBuilder builder)
    {
    ...
    private static void MapVaultPersonalSecrets(ModelBuilder builder)
    {
